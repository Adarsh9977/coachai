...
export default function Home() {
  return (
    <div>
      ...
      <section className="w-full py-8 md:py-16 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
    ...
    <section className="w-full py-12 md:py-24 bg-muted/5">
    <div className="container mx-auto px-4 md:px-6">
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-primary-foreground sm:text-4xl md:text-5xl">Ready to Accelerate Your Careeer?</h2>
            ...
            <Link href='/dashboard' passHref>
              ...
              >
                Start Your Journey Today <ArrowRight className="ml-4 h-4 w-4"/>
              </Button>
            </Link>
          </div>
        </div>
